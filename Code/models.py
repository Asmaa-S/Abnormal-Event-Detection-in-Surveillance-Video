...
def conv_lstm_ae():
    ...
    conv2 = Conv3D(filters=64, kernel_size=(5, 5,1), strides=(2, 2,1), padding='valid', activation='tanh')(conv1)
    ...
    conv3 = Conv3DTranspose(filters=128,kernel_size=(5,5,1),strides=(2,2,1),padding='valid',activation='tanh')(convlstm3)
    decoded = Conv3DTranspose(filters=1,kernel_size=(11,11,1),strides=(4,4,1),padding='valid',activation='tanh')(conv3)
