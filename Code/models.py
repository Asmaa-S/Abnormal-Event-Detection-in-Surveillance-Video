...
def conv_lstm_ae():
    ...
    from keras.layers import Input, Flatten, LayerNormalization
    import yaml
    ...
    t = cfg['time_length']
    input_tensor = Input(shape=(None,t, 227, 227, 1))
    conv1 = TimeDistributed(Conv2D(128, kernel_size=(11, 11), padding='same', strides=(4, 4), name='conv1'),
                            input_shape=(None,t, 227, 227, 1))(input_tensor)

    conv1 = TimeDistributed(LayerNormalization())(conv1)
    ...
    conv2 = TimeDistributed(LayerNormalization())(conv2)
    ...
    deconv1 = TimeDistributed(LayerNormalization())(deconv1)
